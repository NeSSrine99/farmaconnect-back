        ...
        <div class="bg-white rounded-2xl shadow-sm p-6 max-w-2xl">
            ...
            <form method="POST" action="{{ route('admin.users.update', $user->id) }}" enctype="multipart/form-data"
                ...
                <div>
                    ...
                    <select name="role_id" class="w-full mt-1 px-4 py-2 bg-gray-50 border border-gray-200 rounded-xl">
                ...
                {{-- PHOTO --}}
                <div>
                    <label class="text-sm text-gray-600">User Photo</label>
                    ...
                    @if ($user->photo)
                        <img src="{{ asset('storage/' . $user->photo) }}"
                            class="w-16 h-16 mt-3 rounded-full object-cover border">
                    @endif
                </div>
                ...
                <div class="flex justify-end gap-3 pt-2">
                    ...
                    <button
                        class="px-4 py-2 rounded-xl bg-gradient-to-r from-cyan-500 to-blue-500 text-white shadow-md hover:shadow-lg transition">
                        Update User
                    </button>
